...
public class ResultNotiActivity extends MainActivity {
    ...
    private LinearLayout layoutConfirm() {
        ...
        String result = "Đối phương đồng ý!";
        String color = "#00e68a";
        if(data.getAppointmentResponse().getStatus() == 2) {
            result = "Đối phương từ chối!";
            color = "#ff0066";
        }
        rejectButton.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(color)));
        rejectButton.setText(result);
